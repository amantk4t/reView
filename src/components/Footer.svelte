...
<footer
	class="w-screen max-w-full h-fit mt-12 flex flex-col justify-center items-center relative bottom-0 left-0"
>
...
-->
	...
	<div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
		...
		<div class="mt-16 border-t border-gray-100 pt-8">
			<p class="text-center text-xs/relaxed text-gray-500">© 2025. All rights reserved.</p>
		</div>
	</div>
</footer>
