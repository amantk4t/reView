...
<section class="dark:bg-gray-900">
	...
	<div class="flex justify-center">
		<button
			...
			class="flex items-center justify-center w-10 h-10 transition duration-300 transform rounded-full shadow-2xl absolute top-5 left-5 z-50"
		>
			<svg
	...
	<div class="max-w-full">
		...
		<div
			class="relative md:mb-0 w-[95vw] sm:w-[75vw] mx-auto max-w-full flex flex-col mt-20 bg-gray-50 p-2 rounded-md"
		>
			{#if movie.original_name !== undefined && !loading}
				<section class="flex flex-col sm:flex-row items-start gap-4">
					<img
						class="w-full sm:w-60 rounded-md"
					...
					<div class="grid gap-2 w-full">
						...
						<div class="flex items-center gap-1 text-sm">
							...
							<span class="text-gray-600 dark:text-white"> TV </span>
						</div>
						<div class="flex items-center gap-1 text-sm">
							<p class="text-gray-700 font-semibold">Release:</p>
						...
						<div class="flex items-center gap-1 text-sm">
							<p class="text-gray-700 font-semibold">Genres:</p>
						...
						<div class="flex items-center gap-1 text-sm">
							<p class="text-gray-700 font-semibold">Production:</p>
	...
	<h3 class="ml-20 text-xl text-gray-700 font-bold mt-20 mb-5">Similar series</h3>
	<MoviesList {similar} />
</section>
